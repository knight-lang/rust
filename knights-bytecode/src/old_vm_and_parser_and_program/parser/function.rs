use crate::old_vm_and_parser_and_program::program::{DeferredJump, JumpWhen};
use crate::old_vm_and_parser_and_program::{Opcode, ParseError, ParseErrorKind, Parseable, Parser};

...
mod flags {
	...
	if #[cfg(feature = "extensions")] {
		...
		pub struct AssignTo {
			...
			#[arg(long="assign-to-system", name="assign-to-system")]
			pub system: bool,
			...
			/// : OUTPUT * (-a b) c #=> -3
			/// ```
			#[arg(long="assign-to-list", name="assign-to-list")]
			pub list: bool,
			...
			/// : OUTPUT hi1 #=> 4
			/// ```
			#[arg(long="assign-to-text", name="assign-to-text")]
			pub text: bool,
		}
...
struct Cli {
	#[command(flatten)]
	#[command(next_help_heading = "Flags")]
